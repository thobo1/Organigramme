class room:
    def __init__(self, roomId = None, name = None, description = None, typeRoom = None, status = None, mustBeUpdated = None, needsReinitialize = None,
        ...
        self.__type = typeRoom
        self.__status = status
        self.__mustBeUpdated = mustBeUpdated
        self.__needsReinitialize = needsReinitialize
        self.__hasBeenSynced = hasBeenSynced
        ...
        self.__hasBeenUpdated = hasBeenUpdated
